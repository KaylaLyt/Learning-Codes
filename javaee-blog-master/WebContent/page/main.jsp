...
<body>
	...
	<div class="container" id="main">
		...
		<div class="row c_center">
			<div class="col-md-3" id="left_content">
				...
				<div id="title">
					<h2><a href="/Blog/login.html">我的博客</a></h2>
					<h5 class="text-muted">啦啦我们在这里</h5>
				</div>

				<div class="c_center" id="person_info">
					<img src="/Blog/img/header.jpg" height="130" width="130"
						alt="丢失了我的头像?" class="img-circle">
					<h4 class="text-muted">344小仙女</h4>
					<h5 class="text-muted">饭饭和床床 </h5>
					<h5 class="text-muted">吃吃和睡睡</h5>
				</div>
	...
	<div id="footer">
		<div>
			<a href="#"><img src="/Blog/img/github.png"width="20px" height="20px" class="img-circle">MyBlog</a>
